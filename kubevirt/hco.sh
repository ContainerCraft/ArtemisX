...
#kubectl create ns $hco_namespace --dry-run=true -o yaml | kubectl delete -f -

# Create additional namespaces needed for HCO components
namespaces=("openshift")
#for namespace in ${namespaces[@]}; do
#    if [[ $(kubectl get ns ${namespace}) == "" ]]; then
#        kubectl create ns ${namespace} --dry-run=true -o yaml | kubectl delete -f -
#    fi
#done
...
kubectl delete  -f https://raw.githubusercontent.com/kubevirt/hyperconverged-cluster-operator/master/deploy/cert-manager.yaml
...
kubectl delete  -n $hco_namespace -f https://raw.githubusercontent.com/kubevirt/hyperconverged-cluster-operator/master/deploy/webhooks.yaml
